...
class TestToolConfig(unittest.TestCase):
    ...
    def test_generate_xml(self):
        ...
        xml = config.to_xml()
        self.assertEqual(self.normalize(xml), self.normalize(cc_lti_xml))
    ...
    def test_read_xml_config(self):
        ...
        self.assertEqual(self.normalize(config.to_xml()), self.normalize(cc_lti_xml))
